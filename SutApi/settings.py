...
SECRET_KEY = 'django-insecure-9)1!=vzj!dsr8k40=@esz8z+c(y7xu525cpj0z6xu3=fin)+up'
...
WSGI_APPLICATION = 'SutApi.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Ruxsatni tekshirish
    ],
